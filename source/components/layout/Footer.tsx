...
export const Footer: React.FC = () => {
  const socialLinks = [
    ...
    {
      name: 'Email',
      url: 'mailto:nvamsi.krishna2001@gmail.com',
      icon: (
    ...
    <footer className="bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="md:flex md:justify-between md:items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
              ML Engineer | Generative AI Specialist
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800 text-center text-sm text-slate-500 dark:text-slate-400">
          © {new Date().getFullYear()} Vamsi Krishna. Built with React & deployed on GitHub Pages.
        </div>
      </div>
    </footer>
  );
